    ...
    return (
        <div className="bg-white rounded-md px-1 font-inter">
            <div className="flex flex-row">
                <div className="basis-1/2 m-2 text-lm font-medium leading-6" style={{color:"#8E95A9"}}>{data.text}</div>
                <div className="basis-1/2 m-2 text-lm font-bold leading-6" style={{color:`${colorConvert()}`}}>{
                    (data.percent > 0) ? <>+</>:<></>
                } {data.percent} %</div>
            </div>
            <div className="flex flex-row">
                <div className="basis-1/2 m-2 text-2xl font-semibold leading-10">${data.value}</div>
